...
export default function UrlEncoder() {
  ...
  return (
    <div>
      ...
      <h1 className="text-3xl font-bold mb-2 text-white">URL Encoder / Decoder</h1>
      <p className="text-gray-400 mb-6">Encode or decode URL components.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <textarea value={input} onChange={e => setInput(e.target.value)} placeholder="Enter text or URL..." className="w-full h-64 p-4 bg-gray-800 border border-gray-700 rounded text-gray-200 font-mono text-sm resize-none focus:outline-none focus:border-blue-500" />
